    ...
    <div class="container">
        ...
        <div class="edit-profile-header">
            <div class="d-flex justify-content-between align-items-center" style="gap:1rem;">
                <div>
                    <a href="<?php echo e(auth()->id() === $user->id && auth()->user()->user_type !== 'admin' ? route('me.profile') : route('users.profile', $user->id)); ?>" class="nav-link">My Profile</a>
                    <a href="<?php echo e(auth()->id() === $user->id && auth()->user()->user_type !== 'admin' ? route('me.profile.edit') : route('users.profile.edit', $user->id)); ?>" class="nav-link active">Edit Profile</a>
                </div>
        ...
        <div class="edit-profile-content">
            <form action="<?php echo e(auth()->id() === $user->id && auth()->user()->user_type !== 'admin' ? route('me.profile.update') : route('users.profile.update', $user->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="mb-3">
                                    <?php if($user->profile_photo): ?>
                                        <img src="<?php echo e(asset('storage/' . $user->profile_photo)); ?>" alt="Current Photo" 
                                             class="current-photo">
                                    <?php else: ?>
...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          placeholder="Enter your qualifications"><?php echo e(old('qualification', $user->teacher->qualification)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          placeholder="Enter your experience"><?php echo e(old('experience', $user->teacher->experience)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          placeholder="Tell us about yourself"><?php echo e(old('bio', $user->teacher->bio)); ?></textarea>
                                <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group" style="display:flex;gap:1rem;align-items:center;">
                            ...
                            <a href="<?php echo e(route('users.profile', $user->id)); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\SchoolManagementSystem\resources\views/users/edit-profile.blade.php ENDPATH**/ ?>