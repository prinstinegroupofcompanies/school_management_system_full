                ...
                <div class="card password-card">
                    <div class="card-header password-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo e(auth()->id() === $user->id && auth()->user()->user_type !== 'admin' ? route('me.profile') : route('users.profile', $user)); ?>" class="btn btn-light btn-sm">
                                <i class="fas fa-arrow-left me-1"></i> Back to Profile
                            </a>
                        </div>
                    </div>
                    <div class="card-body p-0">
                        <form action="<?php echo e(route('users.change-password.update', $user)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-section">
                                <div class="d-flex justify-content-center gap-3">
                                    <button type="submit" class="btn btn-primary btn-lg">
                                        <i class="fas fa-save me-2"></i> <?php echo e($isAdminResettingOther ? 'Reset Password' : 'Change Password'); ?>

                                    </button>
                                    <a href="<?php echo e(auth()->id() === $user->id && auth()->user()->user_type !== 'admin' ? route('me.profile') : route('users.profile', $user)); ?>" class="btn btn-secondary btn-lg">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\SchoolManagementSystem\resources\views/users/change-password.blade.php ENDPATH**/ ?>