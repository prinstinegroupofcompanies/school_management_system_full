...
<head>
    ...
    <title>Page Not Found - <?php echo e(config('app.name', 'School Management System')); ?></title>
        ...
        <div class="max-w-2xl w-full text-center relative z-10 space-y-8">
            ...
            <div class="glass rounded-2xl p-6 shadow-xl border border-white/20 fade-in-up" style="animation-delay: 0.6s;">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    ?>
                    <?php if($studentsRoute): ?>
                    <a href="<?php echo e($studentsUrl); ?>" class="group p-3 rounded-xl border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 hover:scale-105">
                    <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="group p-3 rounded-xl border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 hover:scale-105">
                    <?php endif; ?>
                    ...
                    ?>
                    <?php if($teachersRoute): ?>
                    <a href="<?php echo e($teachersUrl); ?>" class="group p-3 rounded-xl border border-gray-200 hover:border-purple-300 hover:bg-purple-50 transition-all duration-200 hover:scale-105">
                    <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="group p-3 rounded-xl border border-gray-200 hover:border-purple-300 hover:bg-purple-50 transition-all duration-200 hover:scale-105">
                    <?php endif; ?>
                    ...
                    <a href="<?php echo e(route('classes.index')); ?>" class="group p-3 rounded-xl border border-gray-200 hover:border-yellow-300 hover:bg-yellow-50 transition-all duration-200 hover:scale-105">
                    ...
                    <a href="<?php echo e(route('exams.types.index')); ?>" class="group p-3 rounded-xl border border-gray-200 hover:border-red-300 hover:bg-red-50 transition-all duration-200 hover:scale-105">
...
<?php /**PATH C:\Users\DELL\SchoolManagementSystem\resources\views/errors/404.blade.php ENDPATH**/ ?>