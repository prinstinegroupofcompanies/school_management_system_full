...
class StudentHouse extends Model
{
    ...
    protected $fillable = [
        'name', 'code', 'description', 'color', 'icon', 'motto', 'display_order',
    ...
    public function getInactiveStudentsAttribute(): int
    {
    ...
    {
        return $this->icon ?: 'fas fa-home';
    }

    public function getMottoDisplayAttribute(): string
    {
        return $this->motto ?: 'No motto';
    }
