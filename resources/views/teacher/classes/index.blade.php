            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">
                        {{ $stats['total_classes'] }} {{ Str::plural('Class', $stats['total_classes']) }}
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $stats['average_students'] }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Subjects Taught</dt>
                                <dd class="text-lg font-medium text-gray-900">{{ $stats['subjects_taught'] }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900 mb-6">All My Classes</h3>
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="space-y-2 mb-4">
                                        <p class="text-sm text-gray-500">
                                            <span class="font-medium">Code:</span> {{ $class->code ?? 'N/A' }}
                                        </p>
                                        <p class="text-sm text-gray-500">
                                            <span class="font-medium">Students:</span> {{ $class->students->count() }}
                                        </p>
                                        <p class="text-sm text-gray-500">
                                            <span class="font-medium">Subjects:</span> {{ $class->subjects->count() }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        <a href="{{ route('attendance.student', ['class_id' => $class->id, 'date' => now()->format('Y-m-d')]) }}" 
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-500 mb-6">You haven't been assigned any classes yet. Please contact your administrator.</p>
