...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow rounded-lg mb-8">
            <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="flex items-center">
                        <div class="flex-shrink-0 h-12 w-12">
                            <div class="h-12 w-12 rounded-full bg-blue-500 flex items-center justify-center">
                                <span class="text-lg font-medium text-white">{{ substr($student->user->name ?? 'ST', 0, 2) }}</span>
                            </div>
                        </div>
                        <div class="ml-4">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">{{ $student->user->name ?? 'N/A' }}</h3>
                            <p class="mt-1 text-sm text-gray-500">ID: {{ $student->student_id ?? 'N/A' }} • Class: {{ $student->classRoom->name ?? 'N/A' }}</p>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-6">
                    ...
                    <div class="text-center">
                        <div class="text-2xl font-bold text-purple-600">{{ $stats['attendance_percentage'] }}%</div>
        ...
        <div class="bg-white shadow rounded-lg mb-8">
            <div class="px-4 py-5 sm:p-6">
                <form method="GET" action="{{ route('teacher.attendance.student-summary', $student->id) }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900 mb-6">Attendance Records</h3>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-500">No attendance records found for this student in the selected date range.</p>
                </div>
            </div>
        </div>
        @endif
