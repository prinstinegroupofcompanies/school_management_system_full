<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-gradient-to-br from-blue-50 via-white to-indigo-50">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>{{ config('app.name', 'School Management System') }} - Login</title>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                type="email" 
                                required 
                                class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 @if ($errors->has('email')) border-red-300 focus:ring-red-500 focus:border-red-500 @endif"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                required 
                                class="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 @if ($errors->has('password')) border-red-300 focus:ring-red-500 focus:border-red-500 @endif"
