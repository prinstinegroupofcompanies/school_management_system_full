...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="{{ route('classes.show', $class) }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg transition-colors">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="session" name="session" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('session') border-red-500 @enderror" 
                                    required>
                        ...
                        <div>
                            ...
                            <input type="number" id="capacity" name="capacity" value="{{ old('capacity', $class->capacity) }}" min="1"
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="building" name="building" value="{{ old('building', $class->building) }}" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="floor" name="floor" value="{{ old('floor', $class->floor) }}" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="wing" name="wing" value="{{ old('wing', $class->wing) }}" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                    </div>
                </div>
                ...
                <div class="pb-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('description', $class->description) }}</textarea>
                    </div>
                </div>

                <!-- Submit Button -->
                <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                    <a href="{{ route('classes.show', $class) }}" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
                        Cancel
                    </a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    @if(isset($assignedTeachers) && count($assignedTeachers) > 0)
        @foreach($assignedTeachers as $teacherId)
            ...
            @if($teacher)
                assignedTeachers.push({
                    ...
                    teacherName: '{{ $teacher->user->name ?? 'Unnamed' }}',
                    section: 'General',
