        ...
        <div class="max-w-2xl w-full text-center relative z-10 space-y-8">
            ...
            <div class="glass rounded-2xl p-6 shadow-xl border border-white/20 fade-in-up" style="animation-delay: 0.6s;">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <a href="{{ route('admin.classes.index') }}" class="group p-3 rounded-xl border border-gray-200 hover:border-yellow-300 hover:bg-yellow-50 transition-all duration-200 hover:scale-105">
