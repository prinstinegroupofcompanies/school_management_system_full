...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="text-center py-12">
            ...
            <a href="{{ route('student.dashboard') }}" class="mt-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">
                Back to Dashboard
            </a>
        </div>
        @endif
