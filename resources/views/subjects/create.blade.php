    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="text-gray-600 mt-2">Create a new subject for the curriculum</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            <form action="{{ route('admin.subjects.store') }}" method="POST" class="space-y-6">
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                @if(isset($classes))
                                    @foreach($classes as $class)
                                        <option value="{{ $class->id }}" 
                                                {{ (collect(old('class_ids'))->contains($class->id)) ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="number" id="hours_per_week" name="hours_per_week" value="{{ old('hours_per_week') }}" min="1"
                ...
                <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                    <a href="{{ route('admin.subjects.index') }}" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
                        Cancel
                    </a>
