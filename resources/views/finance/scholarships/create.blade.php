...
<div class="min-h-screen bg-gray-50">
                        ...
                        <ol class="flex items-center space-x-4">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-4 text-gray-500">Create</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <form action="{{ route('finance.scholarships.store') }}" method="POST" id="scholarshipForm">
            @csrf
            ...
            <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="type" 
                                    ...
                                    <option value="merit" {{ old('type') == 'merit' ? 'selected' : '' }}>Merit-based</option>
                                    <option value="need" {{ old('type') == 'need' ? 'selected' : '' }}>Need-based</option>
                                    <option value="sports" {{ old('type') == 'sports' ? 'selected' : '' }}>Sports-based</option>
                                    <option value="community" {{ old('type') == 'community' ? 'selected' : '' }}>Community Service</option>
                ...
                <div class="bg-white shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        <h3 class="text-lg leading-6 font-medium text-gray-900 mb-6">Select Students</h3>
                        
                        <!-- Filters -->
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                            <div>
                                <label for="filter_class" class="block text-sm font-medium text-gray-700 mb-2">
                                    Filter by Class
                                </label>
                                ...
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                            <input type="checkbox" id="select_all" onchange="toggleAll()" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                        </th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                            Student
                                        </th>
...
document.getElementById('scholarshipForm').addEventListener('submit', function(e) {
    ...
    if (selectedStudents.length === 0) {
        e.preventDefault();
        alert('Please select at least one student for the scholarship.');
        return false;
    }
    
    if (selectedStudents.length > parseInt(document.getElementById('max_recipients').value)) {
        e.preventDefault();
        alert('Number of selected students cannot exceed the maximum recipients limit.');
        return false;
    }
});
</script>
