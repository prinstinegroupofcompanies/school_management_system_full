    ...
    <div class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                <h1 class="text-3xl font-bold text-gray-900">Approved Lesson Plans</h1>
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ number_format($stats['this_year']) }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white shadow rounded-lg mb-6">
            <div class="px-4 py-5 sm:p-6">
                ...
                <form method="GET" action="{{ route('admin.lesson-plan-approvals.approved') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                    <div>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 sm:px-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Approved Lesson Plans</h3>
                <p class="mt-1 max-w-2xl text-sm text-gray-500">Review approved lesson plans and their implementation status.</p>
            </div>
            <ul class="divide-y divide-gray-200">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        @if($lessonPlan->approved_at)
                                        <span class="text-xs text-gray-500">
                                            Approved {{ $lessonPlan->approved_at->diffForHumans() }}
                                        </span>
                                        @endif
                                    </div>
                                </div>
                ...
                <li>
                    <div class="px-4 py-12 sm:px-6 text-center">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">No approved lesson plans</h3>
                        <p class="mt-1 text-sm text-gray-500">No lesson plans have been approved yet.</p>
                    </div>
                </li>
                @endforelse
            </ul>
