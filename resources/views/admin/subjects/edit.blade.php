        ...
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('admin.subjects.update', $subject) }}" method="POST" class="p-6">
                ...
                <div class="border-b border-gray-200 pb-6 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" id="hours_per_week" name="hours_per_week" value="{{ old('hours_per_week', $subject->hours_per_week) }}" min="1" max="20"
                ...
                <div class="border-b border-gray-200 pb-6 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" id="passing_marks" name="passing_marks" value="{{ old('passing_marks', $subject->passing_marks) }}" min="0" max="100"
                        ...
                        <div>
                            ...
                            <input type="number" id="full_marks" name="full_marks" value="{{ old('full_marks', $subject->full_marks) }}" min="1" max="500"
                ...
                <div class="flex items-center justify-end space-x-4">
                    <a href="{{ route('admin.subjects.show', $subject) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded transition-colors">
                        Cancel
                    </a>
    ...
    <div class="mt-6">
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Subject Statistics</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="text-center">
                        <div class="text-2xl font-bold text-green-600">{{ $subject->classes->sum('students_count') ?? 0 }}</div>
                        <div class="text-sm text-gray-500">Total Students</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-purple-600">{{ $subject->hours_per_week ?? 0 }}</div>
