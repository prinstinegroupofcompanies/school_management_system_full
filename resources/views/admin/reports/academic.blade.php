        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Comprehensive academic performance analytics and insights</p>
                </div>
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Passed Students</dt>
                                <dd class="text-lg font-medium text-gray-900">{{ number_format($studentStats['passed_students']) }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <span class="font-medium text-green-600">{{ $studentStats['total_students'] > 0 ? round(($studentStats['passed_students'] / $studentStats['total_students']) * 100, 1) : 0 }}%</span>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Failed Students</dt>
                                <dd class="text-lg font-medium text-gray-900">{{ number_format($studentStats['failed_students']) }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <span class="font-medium text-red-600">{{ $studentStats['total_students'] > 0 ? round(($studentStats['failed_students'] / $studentStats['total_students']) * 100, 1) : 0 }}%</span>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ number_format($studentStats['average_grade'], 1) }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <span class="font-medium text-yellow-600">GPA Scale</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Grade Distribution</h3>
                    <div class="h-64">
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Performance Trends</h3>
                    <div class="h-64">
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">Class Performance</h3>
                    <div class="flex space-x-2">
                        <button onclick="exportTable('class-performance-table')" class="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            <svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            Export
                        </button>
                        <button onclick="printTable('class-performance-table')" class="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            <svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" />
                            </svg>
                            Print
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200" id="class-performance-table">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="text-sm text-gray-500">{{ $class->code ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                        {{ $class->passed_students }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                        {{ $class->failed_students }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="w-16 bg-gray-200 rounded-full h-2 mr-2">
                                            <div class="bg-green-600 h-2 rounded-full" style="width: {{ $class->total_students > 0 ? ($class->passed_students / $class->total_students) * 100 : 0 }}%"></div>
                                        </div>
                                        <span class="text-sm text-gray-900">{{ $class->total_students > 0 ? round(($class->passed_students / $class->total_students) * 100, 1) : 0 }}%</span>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
...
<script>
    ...
    function countdown() {
        console.log('Academic reports countdown function called');
        return true;
    }
    ...
    function initializeGradeDistributionChart() {
        ...
        const data = gradeData.map(grade => grade.count);
        const colors = [
    ...
    function initializePerformanceTrendsChart() {
        ...
        const trendData = @json($performanceTrends);
        const labels = trendData.map(trend => trend.month);
        const passData = trendData.map(trend => trend.passed);
        const failData = trendData.map(trend => trend.failed);
    ...
    function sortTable(columnIndex) {
        const table = document.getElementById('class-performance-table');
    ...
    function printTable(tableId) {
        ...
        printWindow.document.write(`
            <html>
                <head>
                    <title>Academic Report - Class Performance</title>
                    <style>
                ...
                <body>
                    <h2>Academic Report - Class Performance</h2>
                    ${table.outerHTML}
                </body>
            </html>
        `);
