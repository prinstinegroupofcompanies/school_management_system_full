...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-3xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">Add Exam Schedule</h1>
        <form method="POST" action="{{ route('admin.exams.schedules.store') }}" class="bg-white shadow rounded-lg p-6 space-y-4">
            @csrf
            <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="academic_year" id="academic_year" value="{{ old('academic_year', date('Y')) }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                ...
                <div>
                    ...
                    <input type="text" name="venue" id="venue" value="{{ old('venue') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
            </div>
