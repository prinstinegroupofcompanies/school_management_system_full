...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-3xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">Add Transport Vehicle</h1>
        <form method="POST" action="{{ route('admin.transport.store') }}" class="bg-white shadow rounded-lg p-6 space-y-4">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="vehicle_number" id="vehicle_number" value="{{ old('vehicle_number') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
                <div>
                    <label for="driver_name" class="block text-sm font-medium text-gray-700">Driver Name</label>
                    <input type="text" name="driver_name" id="driver_name" value="{{ old('driver_name') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
                <div>
                    <label for="driver_phone" class="block text-sm font-medium text-gray-700">Driver Phone</label>
                    <input type="text" name="driver_phone" id="driver_phone" value="{{ old('driver_phone') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
            </div>
            <div>
